...
interface WebClient {
    ...
    suspend fun httpGet(url: String, extraHeaders: Headers?): Response =
        httpGet(url.toHttpUrl(), extraHeaders)
     ...
     */
    suspend fun httpPost(url: String, form: Map<String, String>): Response =
     ...
     */
    suspend fun httpPost(url: String, payload: String): Response =
        httpPost(url.toHttpUrl(), payload, null)
     ...
     * @param body
     */
    suspend fun httpPost(url: String, body: JSONObject): Response =
        httpPost(url.toHttpUrl(), body, null)
